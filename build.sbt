...
libraryDependencies ++= Seq(
	...
	"edu.washington.cs.knowitall.nlptools" % "nlptools-parse-clear_2.10" % "2.4.2" exclude("com.googlecode.clearnlp", "clearnlp"),
	"edu.washington.cs.knowitall.srlie" %% "openie-srl" % "1.0.0-RC1" exclude("com.googlecode.clearnlp", "clearnlp"),
